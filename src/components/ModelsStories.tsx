  ...
  return (
    ...
    >
      <SectionHeader
        ...
        title="Todas modelos do job que voce possa imaginar"
        description=""
      />
      ...
      {models.length === 0 ? (
        ...
        <div className="mt-6">
          <div className="flex flex-wrap justify-start gap-x-2 gap-y-4 sm:gap-x-3 sm:gap-y-5">
          ...
          {ghostCards.length > 0 ? (
            <div className="relative mt-3">
              <div className="flex max-h-[154px] flex-wrap justify-start gap-x-2 gap-y-4 overflow-hidden sm:max-h-[176px] sm:gap-x-3 sm:gap-y-5 md:max-h-[228px]">
