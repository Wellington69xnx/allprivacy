        ...
        >
          <div className="flex min-h-full items-end justify-center md:items-center md:p-6">
            <motion.div
              ...
              className="relative h-[min(92dvh,860px)] w-full overflow-hidden rounded-t-[32px] border border-white/10 bg-[#09090c]/95 shadow-2xl md:h-[min(88vh,860px)] md:w-[min(1120px,95vw)] md:rounded-[32px]"
            ...
            >
              ...
              <div className="grid h-full md:grid-cols-[360px,1fr]">
                <div className="relative h-64 overflow-hidden border-b border-white/10 md:h-full md:border-b-0 md:border-r md:border-white/10">
                  <img
                  ...
                  <div className="absolute inset-x-5 bottom-5">
                    ...
                    <p className="mt-1 text-sm text-zinc-200">{model.handle}</p>
                    <p className="mt-3 max-w-[26ch] text-sm leading-6 text-zinc-200/90">
                      {model.tagline}
                    </p>
                  </div>
                </div>
                ...
                <div className="overflow-y-auto">
                  <div className="p-5 md:p-8">
                    ...
                    <div className="mt-6 rounded-[28px] border border-white/10 bg-gradient-to-r from-white/[0.08] to-white/[0.03] p-4">
